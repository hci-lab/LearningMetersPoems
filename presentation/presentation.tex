...
\begin{frame}[fragile]{Feeding verse to model}
  \begin{center}
\begin{tikzpicture}

\node[inner sep=0pt] (russell) at (5, 3)
    {\includegraphics[width=\textwidth]{taha}};
%\draw[step=0.5, gray, very thin] (0,0) grid (10, 7);

\node at (8, 6.3) {\textarabic{البحر البسيط}};
\node at (1.8, 6) {\textarabic{إِنْنَ البسيط لديه يُبسَطُ الأملُ}};
\end{tikzpicture}
    \end{center}
\end{frame}
...
\begin{center}
\input{threeEncodingEffectOnLearning}
\end{center}
\end{frame}
