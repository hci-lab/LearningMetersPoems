...
# Get the maximum weight from the folder in case continue --done
# =============================================================================
import numpy as np
import os, errno,arcpy
...
check_points_file_path = checkpoints_path+ "/weights-improvement-{epoch:02d}-{loss:.2f}.hdf5"
